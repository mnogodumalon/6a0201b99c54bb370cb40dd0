...
const PROXY_BASE = '';
const APP_ID = '6a0201afdd540315c0f597ed';
...
export default function PublicFormBdbddbErfassung() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Bdbddb Erfassung — Formular</h1>
        </div>
